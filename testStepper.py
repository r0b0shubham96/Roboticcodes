...
htheta3=0 #math.degrees(math.acos(hz/(l1*math.cos(htheta1*math.pi/180) + l2*math.cos((htheta2 + htheta1)*math.pi/180))))
...
oldtheta2=math.degrees(-math.atan((math.sqrt(1-math.pow(((ox*ox+oy*oy-(l1*l1)-(l2*l2))/ (2*l1*l2)), 2)))/(((ox*ox)+(oy*oy)-(l1*l1)-(l2*l2))/(2*l1*l2))))-180 
oldtheta1=math.degrees(math.atan(oy/ox) - math.atan((l2*math.sin(oldtheta2*math.pi/180))/(l1 + l2*math.cos(oldtheta2*math.pi/180))))
oldtheta3=0 #math.degrees(math.acos(oz/(l1*math.cos(oldtheta1*math.pi/180) + l2*math.cos((oldtheta2 + oldtheta1)*math.pi/180))))
...
theta3=0 #math.degrees(math.acos(z/(l1*math.cos(theta1*math.pi/180) + l2*math.cos((theta2 + theta1)*math.pi/180))))
